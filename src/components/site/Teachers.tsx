      ...
      <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {teachers?.map((tc, i) => (
          <motion.div
            ...
            className="rounded-2xl border bg-card p-6 text-center shadow-sm hover:shadow-xl transition"
          >
            ...
            {tc.bio && <p className="mt-3 text-sm text-muted-foreground">{tc.bio}</p>}
          </motion.div>
        ))}
      </div>
    </Section>
