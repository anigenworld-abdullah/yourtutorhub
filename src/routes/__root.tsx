...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BrightMinds Home Tutors — Personalized Tutoring" },
      { name: "description", content: "Expert home tutors for every subject. Personalized lessons that help students shine." },
      { property: "og:title", content: "BrightMinds Home Tutors" },
      { property: "og:description", content: "Expert home tutors for every subject." },
